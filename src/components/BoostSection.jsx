...
const BoostSection = () => {
  ...
  return (
    <section
      ...
      tabIndex="1"
      className=" place-items-center bg-boost-texture bg-no-repeat bg-dark_violet mt-10 py-20
    "
    >
      <div className="grid place-items-center py-10">
        <animated.h2
          style={{ ...springs }}
          className="text-white text-center text-lg md:text-lg lg:text-3xl font-bold font-serif pb-2"
        >
